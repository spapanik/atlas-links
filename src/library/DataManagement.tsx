        ...
        <>
            <section className="data-management" aria-labelledby="data-management-title">
                <div>
                    ...
                    <p>
                        Import browser HTML without tags, or export and re-import editable Atlas
                        Links JSON. Files are processed locally. Bookmark files can contain private
                        URLs, names, and descriptions—review the privacy implications before sharing
                        one with any external tool or LLM.
                    </p>
