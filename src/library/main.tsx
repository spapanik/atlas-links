    ...
    return (
        <>
            ...
            <main className="library">
                ...
                <section className="shortcut-settings" aria-labelledby="shortcuts-title">
                    <div>
                        ...
                        {(captureShortcut === 'Unassigned' ||
                            ...
                            <p className="muted">
                                Assign an available key combination in Chrome shortcuts.
                            </p>
                        )}
                    </div>
                    <button
                ...
                <footer>
                    <p>
                        Bookmarks stay on this device by default. Google sign-in privately stores a
                        backup in your Drive app-data area. Atlas Links collects no analytics or
                        telemetry.{' '}
