...
export function SearchSurface({
    ...
    const tags = useMemo(
        () =>
            [
                ...new Set(
                    bookmarks.filter((bookmark) => !bookmark.deletedAt).flatMap((b) => b.tags),
                ),
    ...
    function handleKeyDown(event: KeyboardEvent<HTMLInputElement>) {
        ...
        const next = getSearchKeyboardAction(
            event.key,
            activeIndex,
            results.length,
            Boolean(query),
            ...
            <main className="search-page">
                ...
                <section className="search-intro" aria-labelledby="search-title">
                    ...
                    <span className="sr-only" id="search-keyboard-help">
                        Use the up and down arrow keys to select a result, Enter to open it, and
                        Escape to clear the selection or search.
                    </span>
